    ...
    return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 145, 'div', [['class',
        ...
        i0.ɵprd(1024, null, i2.NG_VALIDATORS, function (p0_0, p1_0, p2_0) {
            return [p0_0, p1_0, p2_0];
                ...
                'childrenField'], multiple: [8, 'multiple'], expandMode: [9, 'expandMode'],
            maxVisibleItemCount: [10, 'maxVisibleItemCount'] }, null), i0.ɵprd(1024, null, i2.NG_VALUE_ACCESSOR, function (p0_0) {
            return [p0_0];
        ...
        var currVal_57 = true;
        var currVal_58 = 'All';
        var currVal_59 = _co.MaxDisplayed;
        _ck(_v, 60, 1, [currVal_49, currVal_50, currVal_51, currVal_52, currVal_53, currVal_54,
            currVal_55, currVal_56, currVal_57, currVal_58, currVal_59]);
        var currVal_60 = 'multipleSelect';
        var currVal_61 = _co.Disabled;
        var currVal_62 = _co.multipleSelected;
        _ck(_v, 62, 0, currVal_60, currVal_61, currVal_62);
        var currVal_63 = (i0.ɵnov(_v, 62).errors && (i0.ɵnov(_v, 62).dirty || i0.ɵnov(_v, 62).touched));
        _ck(_v, 68, 0, currVal_63);
        var currVal_64 = _co.multipleSelected;
        _ck(_v, 74, 0, currVal_64);
        var currVal_79 = 'MaxDisplayed';
        var currVal_80 = _co.MaxDisplayed;
        _ck(_v, 101, 0, currVal_79, currVal_80);
        var currVal_88 = 'FilterPlaceholder';
        var currVal_89 = !_co.ShowFilter;
        var currVal_90 = _co.FilterPlaceholder;
        ...
        var currVal_65 = i0.ɵnov(_v, 90).ngClassUntouched;
        var currVal_66 = i0.ɵnov(_v, 90).ngClassTouched;
        var currVal_67 = i0.ɵnov(_v, 90).ngClassPristine;
        var currVal_68 = i0.ɵnov(_v, 90).ngClassDirty;
        var currVal_69 = i0.ɵnov(_v, 90).ngClassValid;
        var currVal_70 = i0.ɵnov(_v, 90).ngClassInvalid;
        var currVal_71 = i0.ɵnov(_v, 90).ngClassPending;
        _ck(_v, 86, 0, currVal_65, currVal_66, currVal_67, currVal_68, currVal_69, currVal_70, currVal_71);
        var currVal_72 = i0.ɵnov(_v, 103).ngClassUntouched;
        var currVal_73 = i0.ɵnov(_v, 103).ngClassTouched;
        var currVal_74 = i0.ɵnov(_v, 103).ngClassPristine;
        var currVal_75 = i0.ɵnov(_v, 103).ngClassDirty;
        var currVal_76 = i0.ɵnov(_v, 103).ngClassValid;
        var currVal_77 = i0.ɵnov(_v, 103).ngClassInvalid;
        var currVal_78 = i0.ɵnov(_v, 103).ngClassPending;
        _ck(_v, 97, 0, currVal_72, currVal_73, currVal_74, currVal_75, currVal_76, currVal_77, currVal_78);
        var currVal_81 = i0.ɵnov(_v, 116).ngClassUntouched;
        var currVal_82 = i0.ɵnov(_v, 116).ngClassTouched;
        var currVal_83 = i0.ɵnov(_v, 116).ngClassPristine;
        var currVal_84 = i0.ɵnov(_v, 116).ngClassDirty;
        var currVal_85 = i0.ɵnov(_v, 116).ngClassValid;
        var currVal_86 = i0.ɵnov(_v, 116).ngClassInvalid;
        var currVal_87 = i0.ɵnov(_v, 116).ngClassPending;
        _ck(_v, 111, 0, currVal_81, currVal_82, currVal_83, currVal_84, currVal_85, currVal_86, currVal_87);
        var currVal_91 = _co.ShowFilter;
        _ck(_v, 123, 0, currVal_91);
        var currVal_92 = _co.AllowParentSelection;
        _ck(_v, 131, 0, currVal_92);
        var currVal_93 = _co.Disabled;
        _ck(_v, 139, 0, currVal_93);
    });
}
